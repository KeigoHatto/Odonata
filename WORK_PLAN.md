...
- [x] **W02** ノードとエッジ（点と線）の背景モチーフを復活させ、Hero〜セクションに敷く
- [x] **W03** Hero のビジュアルを写真2枚＋ノード背景で再構成
- [x] **W04** Hero直後に「Odonataについて」を新設し、会社情報への導線を置く
- [x] **W05** 「Odonataの始め方」を「事業内容」に変更し、2カテゴリの並列構成にする
